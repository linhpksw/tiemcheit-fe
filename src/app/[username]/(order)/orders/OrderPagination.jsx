	...
	return (
		<>
			<div className='flex flex-wrap justify-center gap-x-10 gap-y-6 md:flex-nowrap md:justify-center text-lg font-medium'>
				<ReactPaginate
					previousLabel={
						<span className='inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-default-100 text-default-800 transition-all duration-500 hover:border-primary hover:bg-primary hover:text-white'>
