...
const LogDataTable = ({ rows, columns, onSortOrderChange, onRowPerPageChange, onStatusChange, control }) => {
	return (
			...
			<div className='p-6'>
				<div className='flex flex-wrap items-center justify-between gap-4'>
					...
					<div className='flex flex-wrap items-center gap-2'>
						<LogDateRangeFilter control={control} />
											...
											<tr key={idx}>
												{columns.map((column, idx) => {
													...
													if (column.key == 'timestamp') {
														...
														const colorClassName = tableData?.includes('thành công')
															? 'text-green-500'
															: 'text-red-500';
														...
														return (
															<td key={column.key} className='px-4 py-4 text-default-800'>
																{tableData}
															</td>
														);
													}
