        ...
        <div className='rounded-lg border border-default-200'>
            ...
            <div className='px-4'>
                <div className='flex justify-between border-b border-default-200 py-2'>
                    ...
                    <h4 className='text-md font-medium text-default-800'>{formatCurrency(subTotal + discount)}</h4>
                </div>
                ...
                <div className='flex justify-between py-4'>
                    ...
                    <h4 className='text-xl font-medium text-default-800'>{formatCurrency(subTotal)}</h4>
                </div>
            </div>
        </div>
    );
