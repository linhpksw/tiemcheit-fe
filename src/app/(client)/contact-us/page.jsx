          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-lg bg-default-400/10">
              <div className="p-8">
                ...
                <Link
                  href="tel:+1234XXXX123"
                  className="mb-2 text-sm text-default-500 block"
                >
                  +1 234 XXXX 123
                </Link>
                <Link
                  href="tel:+1234XXXX567"
                  className="text-sm text-default-500 block"
                >
                  +1 234 XXXX 567
                </Link>
              </div>
            ...
            <div className="rounded-lg bg-default-400/10">
              <div className="p-8">
                <Link
                  href="mailto:demomail123@mail.com"
                  className="mb-6 flex items-center gap-4"
                >
                ...
                <Link
                  href="mailto:helpdemo123@mail.com"
                  className="text-sm text-default-500 block"
                >
