...
const MegaProductFilter = ({ username }) => {
	return (
		<div
          ...
          <div>
            ...
            >
              <RestaurantFilter />
						...
						<div
							className="hs-collapse open mb-4 w-full space-y-4 overflow-hidden transition-[height] duration-300"
							id="dish_ratings"
						>
							<RatingFilter />
						</div>
