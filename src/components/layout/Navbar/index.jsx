                            ...
                            <ul className="flex items-center justify-end gap-x-6">
                                ...
                                <li className="menu-item flex">
                                    <div className="hs-dropdown relative inline-flex [--placement:bottom] [--trigger:hover]">
                                        ...
                                        <div className="hs-dropdown-menu lg:!-mt-8 z-20 hidden min-w-[200px] rounded-lg border border-default-100 bg-white p-2 opacity-0 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
